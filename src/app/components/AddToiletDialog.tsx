    ...
    <div>
        <Dialog>
            <DialogTrigger asChild>
                <Button className='w-25 h-12 p-5 rounded-lg bg-sky-600 hover:bg-sky-500 font-geograph-web-light'>{text}</Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle className='font-geograph-web-light'> Add Toilet Point</DialogTitle>
                <DialogDescription className='font-geograph-web-light-italic'> You can add toilet point here - <span className='font-geograph-it-bold text-neutral-900 '>must be logged in to do that! </span></DialogDescription>
              </DialogHeader>
              <Separator className='bg-indigo-200'/>
              <div className='flex flex-row w-1/1 justify-around gap-10'>
              <div className='grow-1'>
                <Toilet className='absolute h-9 left-9'></Toilet>
                <Input type='text' onInput={(e)=>setToiletName(e.currentTarget.value)} className='font-geograph-web-light-bold grow-1 pl-10' placeholder='Name of the Toilet Point'></Input>

              </div>
              <div className='grow-1'>
                <MapPinHouse className='absolute h-9 left-71'></MapPinHouse>
                <Input type='text' onInput={(e)=>{setToiletAddress(e.currentTarget.value)}} className='font-geograph-web-light-bold pl-10' placeholder='Address'></Input>
              </div>
              ...
              <div className='flex flex-row w-1/1 justify-around gap-10'>
                ...
                <div className='grow-1'>
                  ...
                  <Input type='text' placeholder='Price' className='font-geograph-web-light-bold pl-10'></Input>  
                </div>
                <div className='grow-1'>
                  <CircleQuestionMark className='absolute h-9 left-71'></CircleQuestionMark>
                  <Input type='text' placeholder='Placeholder' className='font-geograph-web-light-bold pl-10'></Input>
                </div>
              </div>
                
                <div>
                  <NotebookText className='absolute h-10 left-9'></NotebookText>
                  <Textarea onInput={(e)=>setToiletDescription(e.currentTarget.value)} className='font-geograph-web-light-bold pl-10' placeholder='Write something about the Toilet Point...'></Textarea>
                </div>
                  <Separator className='bg-indigo-200'/>
                <div>
                  <DialogDescription className='font-geograph-web-light-italic mb-2'>Add opening hours: </DialogDescription>
